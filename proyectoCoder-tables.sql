...
CREATE TABLE IF NOT EXISTS TIME_DELIVERY (
...
-- table PROD_CATEG
CREATE TABLE IF NOT EXISTS PROD_CATEG (
...
-- table PROD_COLOUR
CREATE TABLE IF NOT EXISTS PROD_COLOUR (
...
-- table PROD_SIZE
CREATE TABLE IF NOT EXISTS PROD_SIZE (
...
-- table PROD_INSERTS_AUDIT
CREATE TABLE IF NOT EXISTS PROD_INSERTS_AUDIT (
    ...
    id_colour INT NOT NULL,
    id_prod_categ INT NOT NULL,
    user_log VARCHAR (100) NOT NULL,
    date_insert DATETIME NOT NULL,
    description VARCHAR (20) NOT NULL,
    CONSTRAINT PK_PROD_INSERTS_AUDIT PRIMARY KEY (id_audit)
);


-- table NEW_CUSTOMER_AUDIT
CREATE TABLE IF NOT EXISTS NEW_CUSTOMER_AUDIT (
	id_audit INT NOT NULL AUTO_INCREMENT,
    id_customer INT NOT NULL,
    first_name VARCHAR (45) NOT NULL,
    last_name VARCHAR (45) NOT NULL,
    ...
    date_insert DATETIME NOT NULL,
    description VARCHAR (20) NOT NULL,
    CONSTRAINT PK_NEW_CUSTOMER_AUDIT PRIMARY KEY (id_audit)
);
...
-- fk prod_inserts_audit to products
ALTER TABLE PROD_INSERTS_AUDIT
ADD CONSTRAINT FK_PROD_INSERTS_AUDIT_PRODUCTS FOREIGN KEY FK_PROD_INSERTS_AUDIT_PRODUCTS (id_product)
	REFERENCES PRODUCTS (id_product);


-- fk new_customer_audit to customers
ALTER TABLE NEW_CUSTOMER_AUDIT
ADD CONSTRAINT FK_NEW_CUSTOMER_AUDIT_CUSTOMERS FOREIGN KEY FK_NEW_CUSTOMER_AUDIT_CUSTOMERS (id_customer)
	REFERENCES CUSTOMERS (id_customer);
